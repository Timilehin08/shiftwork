...
class ShiftsTest < ApplicationSystemTestCase
  ...
  test "creating a Shift" do
    ...
    fill_in "Role name", with: @shift.role_name
    fill_in "Shift end", with: @shift.shift_end
    fill_in "Shift pay", with: @shift.shift_pay
    fill_in "Shift start", with: @shift.shift_start
    check "Shift status" if @shift.shift_status
